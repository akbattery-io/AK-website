      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10">
        ...
        <section className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
          ...
          <button
            ...
            className="h-11 px-5 bg-rose-600 hover:bg-rose-500 text-white rounded-xl text-xs font-bold uppercase tracking-wider transition-all shadow-md shadow-rose-200 flex items-center gap-2"
          >
                        ...
                        <td className="py-3 px-6 text-right">
                          <div className="inline-flex items-center gap-1">
                            <button
                              ...
                              title="View Details"
                              className="w-9 h-9 border border-slate-150 hover:border-slate-300 hover:bg-slate-50 rounded-lg flex items-center justify-center text-slate-500 hover:text-slate-800 transition-all"
                            >
                            ...
                            <button
                              ...
                              title="Edit Customer"
                              className="w-9 h-9 border border-slate-150 hover:border-rose-100 hover:bg-rose-50/30 rounded-lg flex items-center justify-center text-slate-500 hover:text-rose-600 transition-all"
                            >
                            ...
                            <button
                              ...
                              className="w-9 h-9 border border-slate-150 hover:border-red-100 hover:bg-red-50 rounded-lg flex items-center justify-center text-slate-500 hover:text-red-600 transition-all"
                            >
                            ...
                            {customer.latitude && customer.longitude ? (
                              <a
                                ...
                                className="w-9 h-9 border border-slate-150 hover:border-amber-100 hover:bg-amber-50 rounded-lg flex items-center justify-center text-slate-500 hover:text-amber-600 transition-all"
                              >
                ...
                {customers.map((customer) => (
                  <div key={customer.id} className="p-5 flex flex-col gap-4">
                    ...
                    <div className="flex items-center justify-end gap-2.5">
                      <button
                        onClick={() => openViewModal(customer)}
                        className="h-9 px-3 border border-slate-200 text-slate-600 hover:bg-slate-50 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5"
                      >
                      ...
                      <button
                        onClick={() => handleDeleteCustomer(customer.id, customer.customer_name)}
                        className="h-9 px-3 border border-slate-200 text-red-650 hover:bg-red-50 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5"
                      >
